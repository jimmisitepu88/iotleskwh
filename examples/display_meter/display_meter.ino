...
void proses_meter() {
  ...
  tampil_txt("kWh", ST77XX_BLUE, 192, 134 + pos_y);
  tampil_txt("Ene", ST77XX_BLUE, 10, 134 + pos_y);
  tampil_nilai(dt_kwh, ST77XX_BLUE, 10 + pos_x, 130 + pos_y);
...
void tampil_txt(char _buffer[50], int warna, int posX, int posY) {
  tft.setTextColor(warna, ST77XX_WHITE);
  tft.setTextSize(2);
